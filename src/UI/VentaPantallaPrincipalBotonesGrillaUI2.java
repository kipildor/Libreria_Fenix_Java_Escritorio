...
public class VentaPantallaPrincipalBotonesGrillaUI2 extends javax.swing.JDialog {
...
//    ImagenFondo p = new ImagenFondo();
    ...
    public VentaPantallaPrincipalBotonesGrillaUI2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        p.setRuta("/Images/librosAbiertos.jpg");
    ...
    public VentaPantallaPrincipalBotonesGrillaUI2(java.awt.Frame parent, boolean modal, Cliente cli) {
        super(parent, modal);
        initComponents();
        lblFechaActual.setText("Fecha: "+fecha.format(LocalDateTime.now()));
        //CargarLibrosDeVentaGrid();
...
//        tblLibrosVenta.getTableHeader().getColumnModel().getColumn(0).setMinWidth(0);
    ...
    private void initComponents() {
        ...
        pnlCont.add(pnlBuscarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 810, -1));
