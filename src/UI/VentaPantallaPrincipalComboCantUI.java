...
public class VentaPantallaPrincipalComboCantUI extends javax.swing.JDialog {
    ...
    public VentaPantallaPrincipalComboCantUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public VentaPantallaPrincipalComboCantUI(java.awt.Frame parent, boolean modal, Cliente cli) {
        super(parent, modal);
        initComponents();
        lblFechaActual.setText("Fecha: "+fecha.format(LocalDateTime.now()));
        //CargarLibrosDeVentaGrid();
...
//        comboBox.addItem("Trujillo");
        ...
        (tblLibrosVenta.getColumnModel().getColumn(7)).setCellEditor(new DefaultCellEditor(comboBox));
